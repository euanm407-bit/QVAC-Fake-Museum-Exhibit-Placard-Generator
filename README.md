# QVAC Fake Museum Exhibit Placard Generator

Type an everyday object and an on-device AI writes a fake museum exhibit placard for it, with a deterministic pretentiousness meter.
...
Then open http://localhost:29381
